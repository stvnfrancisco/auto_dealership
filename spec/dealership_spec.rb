...
describe(Dealership) do
  ...
  describe('#name') do
    it("returns the name of the dealership") do
      ...
      expect(test_dealership.name()).to(eq("Rusty's Used Cars"))
    end
  end
  ...
  describe('#cars') do
    it("initially returns an empty array of saved dealerships") do
      test_dealership = Dealership.new("Rusty's Used Cars")
  ...
  describe(".clear") do
    it("empties out all of the saved dealerships") do
      Dealership.new("Rusty's Used Cars").save()
      Dealership.clear()
      expect(Dealership.all()).to(eq([]))
    end
  end
  ...
  describe(".find") do
    it("returns a dealership by its id number") do
      test_dealership = Dealership.new("Rusty's Used Cars")
      test_dealership.save()
      test_dealership2 = Dealership.new("PDX Cars")
